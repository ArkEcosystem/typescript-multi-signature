...
import { SignedMultiSignatureTransaction } from "./contracts";

export class PendingMultiSignatureTransaction {
	readonly #transaction: SignedMultiSignatureTransaction;

	public constructor(transaction: SignedMultiSignatureTransaction) {
		this.#transaction = {
			...transaction,
	...
	public needsWalletSignature(publicKey: string): boolean {
		const transaction: SignedMultiSignatureTransaction = this.#transaction;
